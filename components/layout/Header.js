...
const Header = () => {
    ...
    return (
        <nav className="navbar row justify-content-center sticky-top color:yellow">
            <div className="container">
                <div className="col-3 p-0">
                    <div className="navbar-brand">
                        <Link href='/'>
                            <img style={{ cursor: 'pointer' }} src="/images/queenie.jpg" width={200} height={100}  alt="Queenie" si/>
                        </Link>
                    </div>
                </div>
